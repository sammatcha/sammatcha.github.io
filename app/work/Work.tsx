...
export default function Work(){
    ...
    return(
        <div className="w-full " id="work">
            <div className="justify-center flex flex-col items-center w-full scroll-mt-20 lg:scroll-mt-0 py-8 px-5 md:py-20 md:px-8 lg:py-24 lg:px-10 ">
                <h1 className="text-2xl mb-5 md:mb-10 lg:text-4xl text-center lg:text-left">
                    Timeline
                </h1>
